...
console.log('# MT-NOTES: ' + 'MT.Server(http) listening on port ' + app.get('port') + ',' + new Date());
console.log('# MT-NOTES: ' + 'MT.Server(https) listening on port ' + app.get('ssl').port + ',' + new Date());
