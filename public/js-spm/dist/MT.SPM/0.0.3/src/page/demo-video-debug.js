define("MT.SPM/0.0.3/src/page/demo-video-debug", [], function(require, exports, module){
/**
...
var init = function () {
    ...
    var public = require("MT.SPM/0.0.3/src/page/public-debug");
    public.init();

    console.log('Live Page');

    var SOURCE = 'http://media.html5media.info/video.mp4';
    var html5Player = require("MT.SPM/0.0.3/src/components/html5-player-debug").create(
        $('.video-section'),
        $('.video-section video'),
    ...
    var updateBrowser = require("MT.SPM/0.0.3/src/components/update-browser-debug").create('',false);
...
define("MT.SPM/0.0.3/src/page/public-debug", [], function(require, exports, module){
/**
...
exports.init = function () {
    ...
    var toggleNav = require("MT.SPM/0.0.3/src/components/toggle-nav-debug").create($('.nav-ul-toggle a'),$('.nav-ul'));
    toggleNav.init();

};
});
define("MT.SPM/0.0.3/src/components/update-browser-debug", [], function(require, exports, module){
/**
...
define("MT.SPM/0.0.3/src/components/toggle-nav-debug", [], function(require, exports, module){
/**
 * Created by thonatos on 15/1/18.
 */
...
define("MT.SPM/0.0.3/src/components/html5-player-debug", [], function(require, exports, module){
/**
